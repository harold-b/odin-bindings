...
when ODIN_OS == .Darwin {
    ...
    @(private) LIB_NAME   :: "libSDL3" when SDL_STATIC else "libSDL3.0"
    @(private) LIB_SUFFIX :: "_debug" when ODIN_DEBUG else ""

    @(private) LIB :: "./" + LIB_NAME + LIB_SUFFIX + (".a" when SDL_STATIC else ".dylib")
...
foreign sys_sdl3 {
    ...
    @(link_name="SDL_crc16")
    crc16 :: proc(crc: cffi.ushort, data: rawptr, len: cffi.size_t) -> cffi.ushort ---

    @(link_name="SDL_crc32")
    crc32 :: proc(crc: cffi.uint, data: rawptr, len: cffi.size_t) -> cffi.uint ---

    @(link_name="SDL_murmur3_32")
    murmur3_32 :: proc(data: rawptr, len: cffi.size_t, seed: cffi.uint) -> cffi.uint ---
    ...
    memset4 :: proc(dst: rawptr, val: cffi.uint, dwords: cffi.size_t) -> rawptr ---
    ...
    StepUTF8 :: proc(pstr: ^cstring, pslen: ^cffi.size_t) -> cffi.uint ---

    @(link_name="SDL_StepBackUTF8")
    StepBackUTF8 :: proc(start: cstring, pstr: ^cstring) -> cffi.uint ---

    @(link_name="SDL_UCS4ToUTF8")
    UCS4ToUTF8 :: proc(codepoint: cffi.uint, dst: cstring) -> cstring ---
    ...
    @(link_name="SDL_srand")
    srand :: proc(seed: cffi.ulonglong) ---

    @(link_name="SDL_rand")
    rand :: proc(n: cffi.int) -> cffi.int ---

    @(link_name="SDL_randf")
    randf :: proc() -> cffi.float ---

    @(link_name="SDL_rand_bits")
    rand_bits :: proc() -> cffi.uint ---

    @(link_name="SDL_rand_r")
    rand_r :: proc(state: ^cffi.ulonglong, n: cffi.int) -> cffi.int ---

    @(link_name="SDL_randf_r")
    randf_r :: proc(state: ^cffi.ulonglong) -> cffi.float ---

    @(link_name="SDL_rand_bits_r")
    rand_bits_r :: proc(state: ^cffi.ulonglong) -> cffi.uint ---
    ...
    @(link_name="SDL_AsyncIOFromFile")
    AsyncIOFromFile :: proc(file: cstring, mode: cstring) -> ^AsyncIO ---

    @(link_name="SDL_GetAsyncIOSize")
    GetAsyncIOSize :: proc(asyncio: ^AsyncIO) -> cffi.longlong ---

    @(link_name="SDL_ReadAsyncIO")
    ReadAsyncIO :: proc(asyncio: ^AsyncIO, ptr: rawptr, offset: cffi.ulonglong, size: cffi.ulonglong, queue: ^AsyncIOQueue, userdata: rawptr) -> cffi.bool ---

    @(link_name="SDL_WriteAsyncIO")
    WriteAsyncIO :: proc(asyncio: ^AsyncIO, ptr: rawptr, offset: cffi.ulonglong, size: cffi.ulonglong, queue: ^AsyncIOQueue, userdata: rawptr) -> cffi.bool ---

    @(link_name="SDL_CloseAsyncIO")
    CloseAsyncIO :: proc(asyncio: ^AsyncIO, flush: cffi.bool, queue: ^AsyncIOQueue, userdata: rawptr) -> cffi.bool ---

    @(link_name="SDL_CreateAsyncIOQueue")
    CreateAsyncIOQueue :: proc() -> ^AsyncIOQueue ---

    @(link_name="SDL_DestroyAsyncIOQueue")
    DestroyAsyncIOQueue :: proc(queue: ^AsyncIOQueue) ---

    @(link_name="SDL_GetAsyncIOResult")
    GetAsyncIOResult :: proc(queue: ^AsyncIOQueue, outcome: ^AsyncIOOutcome) -> cffi.bool ---

    @(link_name="SDL_WaitAsyncIOResult")
    WaitAsyncIOResult :: proc(queue: ^AsyncIOQueue, outcome: ^AsyncIOOutcome, timeoutMS: cffi.int) -> cffi.bool ---

    @(link_name="SDL_SignalAsyncIOQueue")
    SignalAsyncIOQueue :: proc(queue: ^AsyncIOQueue) ---

    @(link_name="SDL_LoadFileAsync")
    LoadFileAsync :: proc(file: cstring, queue: ^AsyncIOQueue, userdata: rawptr) -> cffi.bool ---
    ...
    CompareAndSwapAtomicU32 :: proc(a: ^AtomicU32, oldval: cffi.uint, newval: cffi.uint) -> cffi.bool ---

    @(link_name="SDL_SetAtomicU32")
    SetAtomicU32 :: proc(a: ^AtomicU32, v: cffi.uint) -> cffi.uint ---

    @(link_name="SDL_GetAtomicU32")
    GetAtomicU32 :: proc(a: ^AtomicU32) -> cffi.uint ---
    ...
    SetNumberProperty :: proc(props: PropertiesID, name: cstring, value: cffi.longlong) -> cffi.bool ---
    ...
    GetNumberProperty :: proc(props: PropertiesID, name: cstring, default_value: cffi.longlong) -> cffi.longlong ---
    ...
    CreateSemaphore :: proc(initial_value: cffi.uint) -> ^Semaphore ---
    ...
    WaitSemaphoreTimeout :: proc(sem: ^Semaphore, timeoutMS: cffi.int) -> cffi.bool ---

    @(link_name="SDL_SignalSemaphore")
    SignalSemaphore :: proc(sem: ^Semaphore) ---

    @(link_name="SDL_GetSemaphoreValue")
    GetSemaphoreValue :: proc(sem: ^Semaphore) -> cffi.uint ---
    ...
    WaitConditionTimeout :: proc(cond: ^Condition, mutex: ^Mutex, timeoutMS: cffi.int) -> cffi.bool ---
    ...
    GetIOSize :: proc(_context: ^IOStream) -> cffi.longlong ---

    @(link_name="SDL_SeekIO")
    SeekIO :: proc(_context: ^IOStream, offset: cffi.longlong, whence: IOWhence) -> cffi.longlong ---

    @(link_name="SDL_TellIO")
    TellIO :: proc(_context: ^IOStream) -> cffi.longlong ---
    ...
    @(link_name="SDL_SaveFile_IO")
    SaveFile_IO :: proc(src: ^IOStream, data: rawptr, datasize: cffi.size_t, closeio: cffi.bool) -> cffi.bool ---

    @(link_name="SDL_SaveFile")
    SaveFile :: proc(file: cstring, data: rawptr, datasize: cffi.size_t) -> cffi.bool ---

    @(link_name="SDL_ReadU8")
    ReadU8 :: proc(src: ^IOStream, value: ^cffi.uchar) -> cffi.bool ---

    @(link_name="SDL_ReadS8")
    ReadS8 :: proc(src: ^IOStream, value: ^cffi.schar) -> cffi.bool ---

    @(link_name="SDL_ReadU16LE")
    ReadU16LE :: proc(src: ^IOStream, value: ^cffi.ushort) -> cffi.bool ---

    @(link_name="SDL_ReadS16LE")
    ReadS16LE :: proc(src: ^IOStream, value: ^cffi.short) -> cffi.bool ---

    @(link_name="SDL_ReadU16BE")
    ReadU16BE :: proc(src: ^IOStream, value: ^cffi.ushort) -> cffi.bool ---

    @(link_name="SDL_ReadS16BE")
    ReadS16BE :: proc(src: ^IOStream, value: ^cffi.short) -> cffi.bool ---

    @(link_name="SDL_ReadU32LE")
    ReadU32LE :: proc(src: ^IOStream, value: ^cffi.uint) -> cffi.bool ---

    @(link_name="SDL_ReadS32LE")
    ReadS32LE :: proc(src: ^IOStream, value: ^cffi.int) -> cffi.bool ---

    @(link_name="SDL_ReadU32BE")
    ReadU32BE :: proc(src: ^IOStream, value: ^cffi.uint) -> cffi.bool ---

    @(link_name="SDL_ReadS32BE")
    ReadS32BE :: proc(src: ^IOStream, value: ^cffi.int) -> cffi.bool ---

    @(link_name="SDL_ReadU64LE")
    ReadU64LE :: proc(src: ^IOStream, value: ^cffi.ulonglong) -> cffi.bool ---

    @(link_name="SDL_ReadS64LE")
    ReadS64LE :: proc(src: ^IOStream, value: ^cffi.longlong) -> cffi.bool ---

    @(link_name="SDL_ReadU64BE")
    ReadU64BE :: proc(src: ^IOStream, value: ^cffi.ulonglong) -> cffi.bool ---

    @(link_name="SDL_ReadS64BE")
    ReadS64BE :: proc(src: ^IOStream, value: ^cffi.longlong) -> cffi.bool ---

    @(link_name="SDL_WriteU8")
    WriteU8 :: proc(dst: ^IOStream, value: cffi.uchar) -> cffi.bool ---

    @(link_name="SDL_WriteS8")
    WriteS8 :: proc(dst: ^IOStream, value: cffi.schar) -> cffi.bool ---

    @(link_name="SDL_WriteU16LE")
    WriteU16LE :: proc(dst: ^IOStream, value: cffi.ushort) -> cffi.bool ---

    @(link_name="SDL_WriteS16LE")
    WriteS16LE :: proc(dst: ^IOStream, value: cffi.short) -> cffi.bool ---

    @(link_name="SDL_WriteU16BE")
    WriteU16BE :: proc(dst: ^IOStream, value: cffi.ushort) -> cffi.bool ---

    @(link_name="SDL_WriteS16BE")
    WriteS16BE :: proc(dst: ^IOStream, value: cffi.short) -> cffi.bool ---

    @(link_name="SDL_WriteU32LE")
    WriteU32LE :: proc(dst: ^IOStream, value: cffi.uint) -> cffi.bool ---

    @(link_name="SDL_WriteS32LE")
    WriteS32LE :: proc(dst: ^IOStream, value: cffi.int) -> cffi.bool ---

    @(link_name="SDL_WriteU32BE")
    WriteU32BE :: proc(dst: ^IOStream, value: cffi.uint) -> cffi.bool ---

    @(link_name="SDL_WriteS32BE")
    WriteS32BE :: proc(dst: ^IOStream, value: cffi.int) -> cffi.bool ---

    @(link_name="SDL_WriteU64LE")
    WriteU64LE :: proc(dst: ^IOStream, value: cffi.ulonglong) -> cffi.bool ---

    @(link_name="SDL_WriteS64LE")
    WriteS64LE :: proc(dst: ^IOStream, value: cffi.longlong) -> cffi.bool ---

    @(link_name="SDL_WriteU64BE")
    WriteU64BE :: proc(dst: ^IOStream, value: cffi.ulonglong) -> cffi.bool ---

    @(link_name="SDL_WriteS64BE")
    WriteS64BE :: proc(dst: ^IOStream, value: cffi.longlong) -> cffi.bool ---
    ...
    @(link_name="SDL_IsAudioDevicePhysical")
    IsAudioDevicePhysical :: proc(devid: AudioDeviceID) -> cffi.bool ---

    @(link_name="SDL_IsAudioDevicePlayback")
    IsAudioDevicePlayback :: proc(devid: AudioDeviceID) -> cffi.bool ---
    ...
    @(link_name="SDL_AudioStreamDevicePaused")
    AudioStreamDevicePaused :: proc(stream: ^AudioStream) -> cffi.bool ---
    ...
    LoadWAV_IO :: proc(src: ^IOStream, closeio: cffi.bool, spec: ^AudioSpec, audio_buf: ^^cffi.uchar, audio_len: ^cffi.uint) -> cffi.bool ---

    @(link_name="SDL_LoadWAV")
    LoadWAV :: proc(path: cstring, spec: ^AudioSpec, audio_buf: ^^cffi.uchar, audio_len: ^cffi.uint) -> cffi.bool ---

    @(link_name="SDL_MixAudio")
    MixAudio :: proc(dst: ^cffi.uchar, src: ^cffi.uchar, format: AudioFormat, len: cffi.uint, volume: cffi.float) -> cffi.bool ---

    @(link_name="SDL_ConvertAudioSamples")
    ConvertAudioSamples :: proc(src_spec: ^AudioSpec, src_data: ^cffi.uchar, src_len: cffi.int, dst_spec: ^AudioSpec, dst_data: ^^cffi.uchar, dst_len: ^cffi.int) -> cffi.bool ---
    ...
    GetMasksForPixelFormat :: proc(format: PixelFormat, bpp: ^cffi.int, Rmask: ^cffi.uint, Gmask: ^cffi.uint, Bmask: ^cffi.uint, Amask: ^cffi.uint) -> cffi.bool ---

    @(link_name="SDL_GetPixelFormatForMasks")
    GetPixelFormatForMasks :: proc(bpp: cffi.int, Rmask: cffi.uint, Gmask: cffi.uint, Bmask: cffi.uint, Amask: cffi.uint) -> PixelFormat ---
    ...
    MapRGB :: proc(format: ^PixelFormatDetails, palette: ^Palette, r: cffi.uchar, g: cffi.uchar, b: cffi.uchar) -> cffi.uint ---

    @(link_name="SDL_MapRGBA")
    MapRGBA :: proc(format: ^PixelFormatDetails, palette: ^Palette, r: cffi.uchar, g: cffi.uchar, b: cffi.uchar, a: cffi.uchar) -> cffi.uint ---

    @(link_name="SDL_GetRGB")
    GetRGB :: proc(pixel: cffi.uint, format: ^PixelFormatDetails, palette: ^Palette, r: ^cffi.uchar, g: ^cffi.uchar, b: ^cffi.uchar) ---

    @(link_name="SDL_GetRGBA")
    GetRGBA :: proc(pixel: cffi.uint, format: ^PixelFormatDetails, palette: ^Palette, r: ^cffi.uchar, g: ^cffi.uchar, b: ^cffi.uchar, a: ^cffi.uchar) ---
    ...
    SetSurfaceColorKey :: proc(surface: ^Surface, enabled: cffi.bool, key: cffi.uint) -> cffi.bool ---

    @(link_name="SDL_SurfaceHasColorKey")
    SurfaceHasColorKey :: proc(surface: ^Surface) -> cffi.bool ---

    @(link_name="SDL_GetSurfaceColorKey")
    GetSurfaceColorKey :: proc(surface: ^Surface, key: ^cffi.uint) -> cffi.bool ---

    @(link_name="SDL_SetSurfaceColorMod")
    SetSurfaceColorMod :: proc(surface: ^Surface, r: cffi.uchar, g: cffi.uchar, b: cffi.uchar) -> cffi.bool ---

    @(link_name="SDL_GetSurfaceColorMod")
    GetSurfaceColorMod :: proc(surface: ^Surface, r: ^cffi.uchar, g: ^cffi.uchar, b: ^cffi.uchar) -> cffi.bool ---

    @(link_name="SDL_SetSurfaceAlphaMod")
    SetSurfaceAlphaMod :: proc(surface: ^Surface, alpha: cffi.uchar) -> cffi.bool ---

    @(link_name="SDL_GetSurfaceAlphaMod")
    GetSurfaceAlphaMod :: proc(surface: ^Surface, alpha: ^cffi.uchar) -> cffi.bool ---
    ...
    FillSurfaceRect :: proc(dst: ^Surface, rect: ^Rect, color: cffi.uint) -> cffi.bool ---

    @(link_name="SDL_FillSurfaceRects")
    FillSurfaceRects :: proc(dst: ^Surface, rects: ^Rect, count: cffi.int, color: cffi.uint) -> cffi.bool ---
    ...
    MapSurfaceRGB :: proc(surface: ^Surface, r: cffi.uchar, g: cffi.uchar, b: cffi.uchar) -> cffi.uint ---

    @(link_name="SDL_MapSurfaceRGBA")
    MapSurfaceRGBA :: proc(surface: ^Surface, r: cffi.uchar, g: cffi.uchar, b: cffi.uchar, a: cffi.uchar) -> cffi.uint ---

    @(link_name="SDL_ReadSurfacePixel")
    ReadSurfacePixel :: proc(surface: ^Surface, x: cffi.int, y: cffi.int, r: ^cffi.uchar, g: ^cffi.uchar, b: ^cffi.uchar, a: ^cffi.uchar) -> cffi.bool ---
    ...
    WriteSurfacePixel :: proc(surface: ^Surface, x: cffi.int, y: cffi.int, r: cffi.uchar, g: cffi.uchar, b: cffi.uchar, a: cffi.uchar) -> cffi.bool ---
    ...
    AcquireCameraFrame :: proc(camera: ^Camera, timestampNS: ^cffi.ulonglong) -> ^Surface ---
    ...
    @(link_name="SDL_ShowFileDialogWithProperties")
    ...
    GetJoystickVendorForID :: proc(instance_id: JoystickID) -> cffi.ushort ---

    @(link_name="SDL_GetJoystickProductForID")
    GetJoystickProductForID :: proc(instance_id: JoystickID) -> cffi.ushort ---

    @(link_name="SDL_GetJoystickProductVersionForID")
    GetJoystickProductVersionForID :: proc(instance_id: JoystickID) -> cffi.ushort ---
    ...
    SetJoystickVirtualAxis :: proc(joystick: ^Joystick, axis: cffi.int, value: cffi.short) -> cffi.bool ---

    @(link_name="SDL_SetJoystickVirtualBall")
    SetJoystickVirtualBall :: proc(joystick: ^Joystick, ball: cffi.int, xrel: cffi.short, yrel: cffi.short) -> cffi.bool ---
    ...
    SetJoystickVirtualHat :: proc(joystick: ^Joystick, hat: cffi.int, value: cffi.uchar) -> cffi.bool ---
    ...
    SendJoystickVirtualSensorData :: proc(joystick: ^Joystick, type: SensorType, sensor_timestamp: cffi.ulonglong, data: ^cffi.float, num_values: cffi.int) -> cffi.bool ---
    ...
    GetJoystickVendor :: proc(joystick: ^Joystick) -> cffi.ushort ---

    @(link_name="SDL_GetJoystickProduct")
    GetJoystickProduct :: proc(joystick: ^Joystick) -> cffi.ushort ---

    @(link_name="SDL_GetJoystickProductVersion")
    GetJoystickProductVersion :: proc(joystick: ^Joystick) -> cffi.ushort ---

    @(link_name="SDL_GetJoystickFirmwareVersion")
    GetJoystickFirmwareVersion :: proc(joystick: ^Joystick) -> cffi.ushort ---
    ...
    GetJoystickGUIDInfo :: proc(guid: GUID, vendor: ^cffi.ushort, product: ^cffi.ushort, version: ^cffi.ushort, crc16: ^cffi.ushort) ---
    ...
    GetJoystickAxis :: proc(joystick: ^Joystick, axis: cffi.int) -> cffi.short ---

    @(link_name="SDL_GetJoystickAxisInitialState")
    GetJoystickAxisInitialState :: proc(joystick: ^Joystick, axis: cffi.int, state: ^cffi.short) -> cffi.bool ---
    ...
    GetJoystickHat :: proc(joystick: ^Joystick, hat: cffi.int) -> cffi.uchar ---
    ...
    RumbleJoystick :: proc(joystick: ^Joystick, low_frequency_rumble: cffi.ushort, high_frequency_rumble: cffi.ushort, duration_ms: cffi.uint) -> cffi.bool ---

    @(link_name="SDL_RumbleJoystickTriggers")
    RumbleJoystickTriggers :: proc(joystick: ^Joystick, left_rumble: cffi.ushort, right_rumble: cffi.ushort, duration_ms: cffi.uint) -> cffi.bool ---

    @(link_name="SDL_SetJoystickLED")
    SetJoystickLED :: proc(joystick: ^Joystick, red: cffi.uchar, green: cffi.uchar, blue: cffi.uchar) -> cffi.bool ---
    ...
    GetGamepadVendorForID :: proc(instance_id: JoystickID) -> cffi.ushort ---

    @(link_name="SDL_GetGamepadProductForID")
    GetGamepadProductForID :: proc(instance_id: JoystickID) -> cffi.ushort ---

    @(link_name="SDL_GetGamepadProductVersionForID")
    GetGamepadProductVersionForID :: proc(instance_id: JoystickID) -> cffi.ushort ---
    ...
    GetGamepadVendor :: proc(gamepad: ^Gamepad) -> cffi.ushort ---

    @(link_name="SDL_GetGamepadProduct")
    GetGamepadProduct :: proc(gamepad: ^Gamepad) -> cffi.ushort ---

    @(link_name="SDL_GetGamepadProductVersion")
    GetGamepadProductVersion :: proc(gamepad: ^Gamepad) -> cffi.ushort ---

    @(link_name="SDL_GetGamepadFirmwareVersion")
    GetGamepadFirmwareVersion :: proc(gamepad: ^Gamepad) -> cffi.ushort ---

    @(link_name="SDL_GetGamepadSerial")
    GetGamepadSerial :: proc(gamepad: ^Gamepad) -> cstring ---

    @(link_name="SDL_GetGamepadSteamHandle")
    GetGamepadSteamHandle :: proc(gamepad: ^Gamepad) -> cffi.ulonglong ---
    ...
    GetGamepadAxis :: proc(gamepad: ^Gamepad, axis: GamepadAxis) -> cffi.short ---
    ...
    RumbleGamepad :: proc(gamepad: ^Gamepad, low_frequency_rumble: cffi.ushort, high_frequency_rumble: cffi.ushort, duration_ms: cffi.uint) -> cffi.bool ---

    @(link_name="SDL_RumbleGamepadTriggers")
    RumbleGamepadTriggers :: proc(gamepad: ^Gamepad, left_rumble: cffi.ushort, right_rumble: cffi.ushort, duration_ms: cffi.uint) -> cffi.bool ---

    @(link_name="SDL_SetGamepadLED")
    SetGamepadLED :: proc(gamepad: ^Gamepad, red: cffi.uchar, green: cffi.uchar, blue: cffi.uchar) -> cffi.bool ---
    ...
    CreateCursor :: proc(data: ^cffi.uchar, mask: ^cffi.uchar, w: cffi.int, h: cffi.int, hot_x: cffi.int, hot_y: cffi.int) -> ^Cursor ---
    ...
    PeepEvents :: proc(events: ^Event, numevents: cffi.int, action: EventAction, minType: cffi.uint, maxType: cffi.uint) -> cffi.int ---

    @(link_name="SDL_HasEvent")
    HasEvent :: proc(type: cffi.uint) -> cffi.bool ---

    @(link_name="SDL_HasEvents")
    HasEvents :: proc(minType: cffi.uint, maxType: cffi.uint) -> cffi.bool ---

    @(link_name="SDL_FlushEvent")
    FlushEvent :: proc(type: cffi.uint) ---

    @(link_name="SDL_FlushEvents")
    FlushEvents :: proc(minType: cffi.uint, maxType: cffi.uint) ---
    ...
    WaitEventTimeout :: proc(event: ^Event, timeoutMS: cffi.int) -> cffi.bool ---
    ...
    SetEventEnabled :: proc(type: cffi.uint, enabled: cffi.bool) ---

    @(link_name="SDL_EventEnabled")
    EventEnabled :: proc(type: cffi.uint) -> cffi.bool ---

    @(link_name="SDL_RegisterEvents")
    RegisterEvents :: proc(numevents: cffi.int) -> cffi.uint ---
    ...
    @(link_name="SDL_GetCurrentDirectory")
    GetCurrentDirectory :: proc() -> cstring ---
    ...
    PushGPUVertexUniformData :: proc(command_buffer: ^GPUCommandBuffer, slot_index: cffi.uint, data: rawptr, length: cffi.uint) ---

    @(link_name="SDL_PushGPUFragmentUniformData")
    PushGPUFragmentUniformData :: proc(command_buffer: ^GPUCommandBuffer, slot_index: cffi.uint, data: rawptr, length: cffi.uint) ---

    @(link_name="SDL_PushGPUComputeUniformData")
    PushGPUComputeUniformData :: proc(command_buffer: ^GPUCommandBuffer, slot_index: cffi.uint, data: rawptr, length: cffi.uint) ---

    @(link_name="SDL_BeginGPURenderPass")
    BeginGPURenderPass :: proc(command_buffer: ^GPUCommandBuffer, color_target_infos: ^GPUColorTargetInfo, num_color_targets: cffi.uint, depth_stencil_target_info: ^GPUDepthStencilTargetInfo) -> ^GPURenderPass ---
    ...
    SetGPUStencilReference :: proc(render_pass: ^GPURenderPass, reference: cffi.uchar) ---

    @(link_name="SDL_BindGPUVertexBuffers")
    BindGPUVertexBuffers :: proc(render_pass: ^GPURenderPass, first_slot: cffi.uint, bindings: ^GPUBufferBinding, num_bindings: cffi.uint) ---
    ...
    BindGPUVertexSamplers :: proc(render_pass: ^GPURenderPass, first_slot: cffi.uint, texture_sampler_bindings: ^GPUTextureSamplerBinding, num_bindings: cffi.uint) ---

    @(link_name="SDL_BindGPUVertexStorageTextures")
    BindGPUVertexStorageTextures :: proc(render_pass: ^GPURenderPass, first_slot: cffi.uint, storage_textures: ^^GPUTexture, num_bindings: cffi.uint) ---

    @(link_name="SDL_BindGPUVertexStorageBuffers")
    BindGPUVertexStorageBuffers :: proc(render_pass: ^GPURenderPass, first_slot: cffi.uint, storage_buffers: ^^GPUBuffer, num_bindings: cffi.uint) ---

    @(link_name="SDL_BindGPUFragmentSamplers")
    BindGPUFragmentSamplers :: proc(render_pass: ^GPURenderPass, first_slot: cffi.uint, texture_sampler_bindings: ^GPUTextureSamplerBinding, num_bindings: cffi.uint) ---

    @(link_name="SDL_BindGPUFragmentStorageTextures")
    BindGPUFragmentStorageTextures :: proc(render_pass: ^GPURenderPass, first_slot: cffi.uint, storage_textures: ^^GPUTexture, num_bindings: cffi.uint) ---

    @(link_name="SDL_BindGPUFragmentStorageBuffers")
    BindGPUFragmentStorageBuffers :: proc(render_pass: ^GPURenderPass, first_slot: cffi.uint, storage_buffers: ^^GPUBuffer, num_bindings: cffi.uint) ---

    @(link_name="SDL_DrawGPUIndexedPrimitives")
    DrawGPUIndexedPrimitives :: proc(render_pass: ^GPURenderPass, num_indices: cffi.uint, num_instances: cffi.uint, first_index: cffi.uint, vertex_offset: cffi.int, first_instance: cffi.uint) ---

    @(link_name="SDL_DrawGPUPrimitives")
    DrawGPUPrimitives :: proc(render_pass: ^GPURenderPass, num_vertices: cffi.uint, num_instances: cffi.uint, first_vertex: cffi.uint, first_instance: cffi.uint) ---

    @(link_name="SDL_DrawGPUPrimitivesIndirect")
    DrawGPUPrimitivesIndirect :: proc(render_pass: ^GPURenderPass, buffer: ^GPUBuffer, offset: cffi.uint, draw_count: cffi.uint) ---

    @(link_name="SDL_DrawGPUIndexedPrimitivesIndirect")
    DrawGPUIndexedPrimitivesIndirect :: proc(render_pass: ^GPURenderPass, buffer: ^GPUBuffer, offset: cffi.uint, draw_count: cffi.uint) ---

    @(link_name="SDL_EndGPURenderPass")
    EndGPURenderPass :: proc(render_pass: ^GPURenderPass) ---

    @(link_name="SDL_BeginGPUComputePass")
    BeginGPUComputePass :: proc(command_buffer: ^GPUCommandBuffer, storage_texture_bindings: ^GPUStorageTextureReadWriteBinding, num_storage_texture_bindings: cffi.uint, storage_buffer_bindings: ^GPUStorageBufferReadWriteBinding, num_storage_buffer_bindings: cffi.uint) -> ^GPUComputePass ---
    ...
    BindGPUComputeSamplers :: proc(compute_pass: ^GPUComputePass, first_slot: cffi.uint, texture_sampler_bindings: ^GPUTextureSamplerBinding, num_bindings: cffi.uint) ---

    @(link_name="SDL_BindGPUComputeStorageTextures")
    BindGPUComputeStorageTextures :: proc(compute_pass: ^GPUComputePass, first_slot: cffi.uint, storage_textures: ^^GPUTexture, num_bindings: cffi.uint) ---

    @(link_name="SDL_BindGPUComputeStorageBuffers")
    BindGPUComputeStorageBuffers :: proc(compute_pass: ^GPUComputePass, first_slot: cffi.uint, storage_buffers: ^^GPUBuffer, num_bindings: cffi.uint) ---

    @(link_name="SDL_DispatchGPUCompute")
    DispatchGPUCompute :: proc(compute_pass: ^GPUComputePass, groupcount_x: cffi.uint, groupcount_y: cffi.uint, groupcount_z: cffi.uint) ---

    @(link_name="SDL_DispatchGPUComputeIndirect")
    DispatchGPUComputeIndirect :: proc(compute_pass: ^GPUComputePass, buffer: ^GPUBuffer, offset: cffi.uint) ---
    ...
    CopyGPUTextureToTexture :: proc(copy_pass: ^GPUCopyPass, source: ^GPUTextureLocation, destination: ^GPUTextureLocation, w: cffi.uint, h: cffi.uint, d: cffi.uint, cycle: cffi.bool) ---

    @(link_name="SDL_CopyGPUBufferToBuffer")
    CopyGPUBufferToBuffer :: proc(copy_pass: ^GPUCopyPass, source: ^GPUBufferLocation, destination: ^GPUBufferLocation, size: cffi.uint, cycle: cffi.bool) ---
    ...
    SetGPUAllowedFramesInFlight :: proc(device: ^GPUDevice, allowed_frames_in_flight: cffi.uint) -> cffi.bool ---
    ...
    AcquireGPUSwapchainTexture :: proc(command_buffer: ^GPUCommandBuffer, window: ^Window, swapchain_texture: ^^GPUTexture, swapchain_texture_width: ^cffi.uint, swapchain_texture_height: ^cffi.uint) -> cffi.bool ---

    @(link_name="SDL_WaitForGPUSwapchain")
    WaitForGPUSwapchain :: proc(device: ^GPUDevice, window: ^Window) -> cffi.bool ---

    @(link_name="SDL_WaitAndAcquireGPUSwapchainTexture")
    WaitAndAcquireGPUSwapchainTexture :: proc(command_buffer: ^GPUCommandBuffer, window: ^Window, swapchain_texture: ^^GPUTexture, swapchain_texture_width: ^cffi.uint, swapchain_texture_height: ^cffi.uint) -> cffi.bool ---
    ...
    WaitForGPUFences :: proc(device: ^GPUDevice, wait_all: cffi.bool, fences: ^^GPUFence, num_fences: cffi.uint) -> cffi.bool ---
    ...
    GPUTextureFormatTexelBlockSize :: proc(format: GPUTextureFormat) -> cffi.uint ---
    ...
    CalculateGPUTextureFormatSize :: proc(format: GPUTextureFormat, width: cffi.uint, height: cffi.uint, depth_or_layer_count: cffi.uint) -> cffi.uint ---
    ...
    GetHapticFeatures :: proc(haptic: ^Haptic) -> cffi.uint ---
    ...
    RunHapticEffect :: proc(haptic: ^Haptic, effect: cffi.int, iterations: cffi.uint) -> cffi.bool ---
    ...
    PlayHapticRumble :: proc(haptic: ^Haptic, strength: cffi.float, length: cffi.uint) -> cffi.bool ---
    ...
    hid_device_change_count :: proc() -> cffi.uint ---
    ...
    @(link_name="SDL_IsMainThread")
    IsMainThread :: proc() -> cffi.bool ---

    @(link_name="SDL_RunOnMainThread")
    RunOnMainThread :: proc(callback: MainThreadCallback, userdata: rawptr, wait_complete: cffi.bool) -> cffi.bool ---
    ...
    SetTextureColorMod :: proc(texture: ^Texture, r: cffi.uchar, g: cffi.uchar, b: cffi.uchar) -> cffi.bool ---
    ...
    GetTextureColorMod :: proc(texture: ^Texture, r: ^cffi.uchar, g: ^cffi.uchar, b: ^cffi.uchar) -> cffi.bool ---
    ...
    SetTextureAlphaMod :: proc(texture: ^Texture, alpha: cffi.uchar) -> cffi.bool ---
    ...
    GetTextureAlphaMod :: proc(texture: ^Texture, alpha: ^cffi.uchar) -> cffi.bool ---
    ...
    UpdateYUVTexture :: proc(texture: ^Texture, rect: ^Rect, Yplane: ^cffi.uchar, Ypitch: cffi.int, Uplane: ^cffi.uchar, Upitch: cffi.int, Vplane: ^cffi.uchar, Vpitch: cffi.int) -> cffi.bool ---

    @(link_name="SDL_UpdateNVTexture")
    UpdateNVTexture :: proc(texture: ^Texture, rect: ^Rect, Yplane: ^cffi.uchar, Ypitch: cffi.int, UVplane: ^cffi.uchar, UVpitch: cffi.int) -> cffi.bool ---
    ...
    SetRenderDrawColor :: proc(renderer: ^Renderer, r: cffi.uchar, g: cffi.uchar, b: cffi.uchar, a: cffi.uchar) -> cffi.bool ---
    ...
    GetRenderDrawColor :: proc(renderer: ^Renderer, r: ^cffi.uchar, g: ^cffi.uchar, b: ^cffi.uchar, a: ^cffi.uchar) -> cffi.bool ---
    ...
    @(link_name="SDL_RenderTextureAffine")
    RenderTextureAffine :: proc(renderer: ^Renderer, texture: ^Texture, srcrect: ^FRect, origin: ^FPoint, right: ^FPoint, down: ^FPoint) -> cffi.bool ---
    ...
    AddVulkanRenderSemaphores :: proc(renderer: ^Renderer, wait_stage_mask: cffi.uint, wait_semaphore: cffi.longlong, signal_semaphore: cffi.longlong) -> cffi.bool ---
    ...
    @(link_name="SDL_RenderDebugTextFormat")
    RenderDebugTextFormat :: proc(renderer: ^Renderer, x: cffi.float, y: cffi.float, fmt: cstring, #c_vararg args: ..any) -> cffi.bool ---
    ...
    GetStorageFileSize :: proc(storage: ^Storage, path: cstring, length: ^cffi.ulonglong) -> cffi.bool ---

    @(link_name="SDL_ReadStorageFile")
    ReadStorageFile :: proc(storage: ^Storage, path: cstring, destination: rawptr, length: cffi.ulonglong) -> cffi.bool ---

    @(link_name="SDL_WriteStorageFile")
    WriteStorageFile :: proc(storage: ^Storage, path: cstring, source: rawptr, length: cffi.ulonglong) -> cffi.bool ---
    ...
    GetStorageSpaceRemaining :: proc(storage: ^Storage) -> cffi.ulonglong ---
    ...
    TimeToWindows :: proc(ticks: Time, dwLowDateTime: ^cffi.uint, dwHighDateTime: ^cffi.uint) ---

    @(link_name="SDL_TimeFromWindows")
    TimeFromWindows :: proc(dwLowDateTime: cffi.uint, dwHighDateTime: cffi.uint) -> Time ---
    ...
    GetTicks :: proc() -> cffi.ulonglong ---

    @(link_name="SDL_GetTicksNS")
    GetTicksNS :: proc() -> cffi.ulonglong ---

    @(link_name="SDL_GetPerformanceCounter")
    GetPerformanceCounter :: proc() -> cffi.ulonglong ---

    @(link_name="SDL_GetPerformanceFrequency")
    GetPerformanceFrequency :: proc() -> cffi.ulonglong ---

    @(link_name="SDL_Delay")
    Delay :: proc(ms: cffi.uint) ---

    @(link_name="SDL_DelayNS")
    DelayNS :: proc(ns: cffi.ulonglong) ---

    @(link_name="SDL_DelayPrecise")
    DelayPrecise :: proc(ns: cffi.ulonglong) ---

    @(link_name="SDL_AddTimer")
    AddTimer :: proc(interval: cffi.uint, callback: TimerCallback, userdata: rawptr) -> TimerID ---

    @(link_name="SDL_AddTimerNS")
    AddTimerNS :: proc(interval: cffi.ulonglong, callback: NSTimerCallback, userdata: rawptr) -> TimerID ---

    @(link_name="SDL_RemoveTimer")
    RemoveTimer :: proc(id: TimerID) -> cffi.bool ---

    @(link_name="SDL_CreateTray")
    CreateTray :: proc(icon: ^Surface, tooltip: cstring) -> ^Tray ---

    @(link_name="SDL_SetTrayIcon")
    SetTrayIcon :: proc(tray: ^Tray, icon: ^Surface) ---

    @(link_name="SDL_SetTrayTooltip")
    SetTrayTooltip :: proc(tray: ^Tray, tooltip: cstring) ---

    @(link_name="SDL_CreateTrayMenu")
    CreateTrayMenu :: proc(tray: ^Tray) -> ^TrayMenu ---

    @(link_name="SDL_CreateTraySubmenu")
    CreateTraySubmenu :: proc(entry: ^TrayEntry) -> ^TrayMenu ---

    @(link_name="SDL_GetTrayMenu")
    GetTrayMenu :: proc(tray: ^Tray) -> ^TrayMenu ---

    @(link_name="SDL_GetTraySubmenu")
    GetTraySubmenu :: proc(entry: ^TrayEntry) -> ^TrayMenu ---

    @(link_name="SDL_GetTrayEntries")
    GetTrayEntries :: proc(menu: ^TrayMenu, size: ^cffi.int) -> ^^TrayEntry ---

    @(link_name="SDL_RemoveTrayEntry")
    RemoveTrayEntry :: proc(entry: ^TrayEntry) ---

    @(link_name="SDL_InsertTrayEntryAt")
    InsertTrayEntryAt :: proc(menu: ^TrayMenu, pos: cffi.int, label: cstring, flags: TrayEntryFlags) -> ^TrayEntry ---

    @(link_name="SDL_SetTrayEntryLabel")
    SetTrayEntryLabel :: proc(entry: ^TrayEntry, label: cstring) ---

    @(link_name="SDL_GetTrayEntryLabel")
    GetTrayEntryLabel :: proc(entry: ^TrayEntry) -> cstring ---

    @(link_name="SDL_SetTrayEntryChecked")
    SetTrayEntryChecked :: proc(entry: ^TrayEntry, checked: cffi.bool) ---

    @(link_name="SDL_GetTrayEntryChecked")
    GetTrayEntryChecked :: proc(entry: ^TrayEntry) -> cffi.bool ---

    @(link_name="SDL_SetTrayEntryEnabled")
    SetTrayEntryEnabled :: proc(entry: ^TrayEntry, enabled: cffi.bool) ---

    @(link_name="SDL_GetTrayEntryEnabled")
    GetTrayEntryEnabled :: proc(entry: ^TrayEntry) -> cffi.bool ---

    @(link_name="SDL_SetTrayEntryCallback")
    SetTrayEntryCallback :: proc(entry: ^TrayEntry, callback: TrayCallback, userdata: rawptr) ---

    @(link_name="SDL_ClickTrayEntry")
    ClickTrayEntry :: proc(entry: ^TrayEntry) ---

    @(link_name="SDL_DestroyTray")
    DestroyTray :: proc(tray: ^Tray) ---

    @(link_name="SDL_GetTrayEntryParent")
    GetTrayEntryParent :: proc(entry: ^TrayEntry) -> ^TrayMenu ---

    @(link_name="SDL_GetTrayMenuParentEntry")
    GetTrayMenuParentEntry :: proc(menu: ^TrayMenu) -> ^TrayEntry ---

    @(link_name="SDL_GetTrayMenuParentTray")
    GetTrayMenuParentTray :: proc(menu: ^TrayMenu) -> ^Tray ---

    @(link_name="SDL_UpdateTrays")
    UpdateTrays :: proc() ---
    ...
    @(link_name="SDL_GDKSuspendComplete")
...
/// SDL_SpinLock
SpinLock :: distinct cffi.int

/// SDL_PropertiesID
PropertiesID :: distinct cffi.uint
...
/// SDL_ThreadID
ThreadID :: distinct cffi.ulonglong

/// SDL_TLSID
TLSID :: distinct AtomicInt
...
/// SDL_AudioDeviceID
AudioDeviceID :: distinct cffi.uint
...
/// SDL_DisplayID
DisplayID :: distinct cffi.uint

/// SDL_WindowID
WindowID :: distinct cffi.uint
...
/// SDL_GLContextFlag
GLContextFlag :: cffi.uint

/// SDL_GLContextReleaseFlag
GLContextReleaseFlag :: cffi.uint

/// SDL_GLContextResetNotification
GLContextResetNotification :: cffi.uint
...
/// SDL_SensorID
SensorID :: distinct cffi.uint

/// SDL_JoystickID
JoystickID :: distinct cffi.uint

/// SDL_KeyboardID
KeyboardID :: distinct cffi.uint

/// SDL_MouseID
MouseID :: distinct cffi.uint

/// SDL_TouchID
TouchID :: distinct cffi.ulonglong

/// SDL_FingerID
FingerID :: distinct cffi.ulonglong

/// SDL_PenID
PenID :: distinct cffi.uint
...
/// SDL_TimerID
TimerID :: distinct cffi.uint

/// SDL_TimerCallback
TimerCallback :: proc "c" (userdata: rawptr, timerID: TimerID, interval: cffi.uint) -> cffi.uint

/// SDL_NSTimerCallback
NSTimerCallback :: proc "c" (userdata: rawptr, timerID: TimerID, interval: cffi.ulonglong) -> cffi.ulonglong
...
/// SDLX_GPUShaderFormat
GPUShaderFormat :: enum cffi.uint {
    INVALID = 0,
    PRIVATE = 1,
    SPIRV = 2,
    DXBC = 4,
...
TrayEntryFlags :: bit_set[TrayEntryFlag; cffi.uint]
...
/// SDL_AsyncIOTaskType
AsyncIOTaskType :: enum cffi.uint {
    READ = 0,
    WRITE = 1,
    CLOSE = 2,
}
...
/// SDL_AsyncIOOutcome
AsyncIOOutcome :: struct #align (8) {
    asyncio: ^AsyncIO,
    type: AsyncIOTaskType,
    result: AsyncIOResult,
    buffer: rawptr,
    offset: cffi.ulonglong,
    bytes_requested: cffi.ulonglong,
    bytes_transferred: cffi.ulonglong,
    userdata: rawptr,
}
#assert(size_of(AsyncIOOutcome) == 56)
...
IOStreamInterface :: struct #align (8) {
    version: cffi.uint,
    size: proc "c" (userdata: rawptr) -> cffi.longlong,
    seek: proc "c" (userdata: rawptr, offset: cffi.longlong, whence: IOWhence) -> cffi.longlong,
...
PixelFormatDetails :: struct #align (4) {
    format: PixelFormat,
    bits_per_pixel: cffi.uchar,
    bytes_per_pixel: cffi.uchar,
    padding: [2]cffi.uchar,
    Rmask: cffi.uint,
    Gmask: cffi.uint,
    Bmask: cffi.uint,
    Amask: cffi.uint,
...
VirtualJoystickTouchpadDesc :: struct #align (2) {
    nfingers: cffi.ushort,
    padding: [3]cffi.ushort,
}
...
VirtualJoystickDesc :: struct #align (8) {
    ...
    naxes: cffi.ushort,
    nbuttons: cffi.ushort,
    nballs: cffi.ushort,
    nhats: cffi.ushort,
    ntouchpads: cffi.ushort,
    nsensors: cffi.ushort,
    padding2: [2]cffi.ushort,
    button_mask: cffi.uint,
    axis_mask: cffi.uint,
    name: cstring,
    ...
    Rumble: proc "c" (userdata: rawptr, low_frequency_rumble: cffi.ushort, high_frequency_rumble: cffi.ushort) -> cffi.bool,
    RumbleTriggers: proc "c" (userdata: rawptr, left_rumble: cffi.ushort, right_rumble: cffi.ushort) -> cffi.bool,
    SetLED: proc "c" (userdata: rawptr, red: cffi.uchar, green: cffi.uchar, blue: cffi.uchar) -> cffi.bool,
...
TextEditingCandidatesEvent :: struct #align (8) {
    ...
    windowID: WindowID,
    candidates: ^cstring,
    num_candidates: cffi.int,
    selected_candidate: cffi.int,
...
GamepadSensorEvent :: struct #align (8) {
    ...
    sensor: cffi.int,
    data: [3]cffi.float,
    sensor_timestamp: cffi.ulonglong,
}
...
/// SDL_RenderEvent
RenderEvent :: struct #align (8) {
    type: EventType,
    reserved: cffi.uint,
    timestamp: cffi.ulonglong,
    windowID: WindowID,
}
#assert(size_of(RenderEvent) == 24)
...
GPUTextureTransferInfo :: struct #align (8) {
    ...
    offset: cffi.uint,
    pixels_per_row: cffi.uint,
    rows_per_layer: cffi.uint,
}
...
GPUBlitRegion :: struct #align (8) {
    texture: ^GPUTexture,
    mip_level: cffi.uint,
    layer_or_depth_plane: cffi.uint,
    x: cffi.uint,
    y: cffi.uint,
    w: cffi.uint,
    h: cffi.uint,
...
GPUIndirectDrawCommand :: struct #align (4) {
    num_vertices: cffi.uint,
    num_instances: cffi.uint,
    first_vertex: cffi.uint,
    first_instance: cffi.uint,
}
#assert(size_of(GPUIndirectDrawCommand) == 16)

/// SDL_GPUIndexedIndirectDrawCommand
GPUIndexedIndirectDrawCommand :: struct #align (4) {
    num_indices: cffi.uint,
    num_instances: cffi.uint,
    first_index: cffi.uint,
    vertex_offset: cffi.int,
    first_instance: cffi.uint,
}
...
GPUIndirectDispatchCommand :: struct #align (4) {
    groupcount_x: cffi.uint,
    groupcount_y: cffi.uint,
    groupcount_z: cffi.uint,
}
...
GPUVertexInputState :: struct #align (8) {
    ...
    num_vertex_buffers: cffi.uint,
    vertex_attributes: ^GPUVertexAttribute,
    num_vertex_attributes: cffi.uint,
}
...
GPUShaderCreateInfo :: struct #align (8) {
    ...
    num_samplers: cffi.uint,
    num_storage_textures: cffi.uint,
    num_storage_buffers: cffi.uint,
    num_uniform_buffers: cffi.uint,
    props: PropertiesID,
}
...
GPUTextureCreateInfo :: struct #align (4) {
    ...
    width: cffi.uint,
    height: cffi.uint,
    layer_count_or_depth: cffi.uint,
    num_levels: cffi.uint,
...
GPUDepthStencilState :: struct #align (4) {
    ...
    compare_mask: cffi.uchar,
    write_mask: cffi.uchar,
...
GPUComputePipelineCreateInfo :: struct #align (8) {
    ...
    format: GPUShaderFormat,
    num_samplers: cffi.uint,
    num_readonly_storage_textures: cffi.uint,
    num_readonly_storage_buffers: cffi.uint,
    num_readwrite_storage_textures: cffi.uint,
    num_readwrite_storage_buffers: cffi.uint,
    num_uniform_buffers: cffi.uint,
    threadcount_x: cffi.uint,
    threadcount_y: cffi.uint,
    threadcount_z: cffi.uint,
    props: PropertiesID,
}
...
GPUColorTargetInfo :: struct #align (8) {
    ...
    resolve_mip_level: cffi.uint,
    resolve_layer: cffi.uint,
    cycle: cffi.bool,
...
HapticConstant :: struct #align (4) {
    ...
    delay: cffi.ushort,
    button: cffi.ushort,
    interval: cffi.ushort,
    level: cffi.short,
    attack_length: cffi.ushort,
    attack_level: cffi.ushort,
    fade_length: cffi.ushort,
    fade_level: cffi.ushort,
}
...
HapticCondition :: struct #align (4) {
    ...
    button: cffi.ushort,
    interval: cffi.ushort,
    right_sat: [3]cffi.ushort,
    left_sat: [3]cffi.ushort,
    right_coeff: [3]cffi.short,
    left_coeff: [3]cffi.short,
    deadband: [3]cffi.ushort,
    center: [3]cffi.short,
}
...
HapticLeftRight :: struct #align (4) {
    type: cffi.ushort,
    length: cffi.uint,
    large_magnitude: cffi.ushort,
    small_magnitude: cffi.ushort,
}
...
StorageInterface :: struct #align (8) {
    ...
    read_file: proc "c" (userdata: rawptr, path: cstring, destination: rawptr, length: cffi.ulonglong) -> cffi.bool,
    write_file: proc "c" (userdata: rawptr, path: cstring, source: rawptr, length: cffi.ulonglong) -> cffi.bool,
    ...
    space_remaining: proc "c" (userdata: rawptr) -> cffi.ulonglong,
}
